...
function initPollingChat() {
  ...
  squadId = document.getElementById('squad-id')?.value || 
  ...
  console.log('Current user:', currentUser.username || currentUser.email || 'Anonymous');
...
window.sendSquadMessage = sendMessage; 
